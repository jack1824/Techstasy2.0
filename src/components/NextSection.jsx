      ...
      <div ref={scroll} id="scroll">
        ...
        <div className="w-[50%] absolute top-0 sm:-top-10 right-1/4 z-10 flex justify-center items-center">
          ...
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 flex flex-col items-center gap-4 w-full">
            ...
            <div className="bg-white border-4 border-black rounded-full px-6 py-1 md:px-10 md:py-2 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
              <span className="text-xl md:text-3xl font-black tracking-widest font-kungfu">
