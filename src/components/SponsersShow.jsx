...
const sponsors = {
  silver: [
    { name: "OSEN", logo: "/Sponsors/OsenSponser.png",link:"https://osen.co.in/" },
  ],
  platform: [
    { name: "UptoSkills", logo: "/Sponsors/UptoSkillSponser.png",link:"https://www.uptoskills.com/" },
  ],
  general: [
    { name: "Bitcoin Bharat", logo: "/Sponsors/btcbharatSponser.png",link:"https://btcbharat.com/" },
    { name: "Commudle", logo: "/Sponsors/CommudleSponser.png",link:"https://commudle.com/" },
    { name: "XYZ", logo: "/Sponsors/xyzSponser.jpeg",link:"https://xyz.com/" },
    { name: "Code", logo: "/Sponsors/codeSponser.png",link:"https://code.com/" },
  ],
};
    ...
    <div className="w-full text-center flex flex-col justify-center items-center gap-20 py-10 text-orange-500">
      <div className="w-full h-auto flex justify-center flex-col items-center gap-10 py-5 flex-wrap">
        ...
        {sponsors.silver.map((sponser) => (
          <a href={sponser.link} target="_blank" rel="noopener noreferrer">
            <img className="w-[20vh] md:w-[20vw]" src={sponser.logo} alt={sponser.name} />
            </a>
        ))}
      ...
      <div className="w-full flex-col h-auto flex justify-center items-center gap-10 py-5 flex-wrap">
        ...
        <div className="flex gap-10 justify-center items-center ">
          ...
          <a href={sponser.link} target="_blank" rel="noopener noreferrer">
            <img className="w-[15vh] md:w-[15vw]" src={sponser.logo} alt={sponser.name} />
            </a>
        ))}
